...
### University of Bonn
* For my thesis I worked with [Norbert Langer](https://astro.uni-bonn.de/~nlanger) to study massive single stars in the Milky Way. I used evolutionary models and population synthesis of single rotating stars at Galactic metallicity to investigate stellar spindown and envelope inflation in massive main sequence stars. I compared my results to a selection of stars from [The IACOB Project](http://research.iac.es/proyecto/iacob/pages/en/introduction.php), a long term spectroscopic study of Galactic OB stars. You can view my thesis [here](https://astro.uni-bonn.de/~nlanger/thesis/kaila-master.pdf).
